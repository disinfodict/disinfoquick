# Team & Partners {.unnumbered}

## Core team

### Nord Atlantic Fella Organiztion (NAFO)

Maker and User of the dictionary: [NAFO](https://nafo-ofan.org/en-de) is a grassroots movement that fights disinformation and supports freedom and democracy worldwide with a focus on Ukraine.
...
Invited as content curator: the *German-Ukrainian Association - for our and your freedom*, which is currently being founded, is not yet operational and has not yet decided to take a content-curating role.
...
Project development and start-up financing: [TechCamp](https://techcamp.america.gov/) TechCamp is a public diplomacy program hosted in the Bureau of Educational & Cultural Affairs (ECA) at the U.S. Department of State.
...
Website hosting: [Netlify](https://www.netlify.com) Core provides developers with the platform and workflow to immediately focus on building websites and apps without dedicating time and resources on labor-intensive operations. Content deployed to the edge nodes is fully prerendered and static, offering no active processes or surface area for attack.
