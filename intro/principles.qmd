...
-   everyone committing to these Values & Principles can contribute (see [Contribute] below)
-   please let us know if something seems wrong (see [Contribute] below)
...
You can send plaintext suggestions for improvements - preferably as a [quarto markdown](https://quarto.org/docs/authoring/markdown-basics.html) *.qmd file - [contribute [at] disinfodict [dot] org](mailto:contribute@disinfodict.org). The syntax for defining section headers, footnotes and integrate pictures is simple, see for example [part brothers | chapter russiam the file russia.qmd](https://github.com/disinfodict/disinfodict/blob/main/brothers). There is also a [mini demo dictionary](https://github.com/disinfodict/disinfoquick) for learning. For an overview which chapters still require work see [status](#sec-intro-status).
For multiple contributions you can fork the [dictionary at github](https://github.com/disinfodict/disinfodict) and create a pull-request (see the [README](https://github.com/disinfodict/disinfodict)).
