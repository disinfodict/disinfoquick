...
- jeder, der sich zu diesen Werten und Grundsätzen bekennt, kann einen Beitrag leisten (siehe *Beiträge* unten)
- bitte lassen Sie uns wissen, wenn etwas falsch erscheint (siehe *Beiträge* unten)
...
- Die Navigationsnamen der Teile können in `_quarto.yml` umbenannt werden
...
Sie benötigen ein [GitHub](https://github.com/signup?ref_cta=Sign+up) Konto, um Beiträge zu leisten.

- Erstelle ein Issue auf GitHub und erkläre deine Verbesserung (mit verlässlichen Quellen)
- Erstelle ein Issue auf GitHub und poste einen neuen Abschnitt mit [markdown code](https://quarto.org/docs/authoring/markdown-basics.html)
- eine Issue auf GitHub stellen und ein neues Kapitel anhängen (`<Dateiname>.qmd`, und optional eine `<Dateiname>.bib` mit Referenzdaten)
- regelmäßige Mitwirkende sollten in Erwägung ziehen zu lernen, wie man [pull-requests] einreicht (https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/getting-started/about-collaborative-development-models)
